...
mut_file = os.path.join(BASE_DIR, 'data', 'circadian_all_mutations_extracted.csv')
out_fig = os.path.join(BASE_DIR, 'figures', 'Figure_2_Consolidated_Mutational_Landscape.png')
...
print('Figure 2 generated successfully at:', out_fig)
